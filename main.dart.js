...
["crypto", "package:crypto/crypto.dart", , M, {
  "^": "",
  _CryptoUtils_base64StringToBytes: function(input) {
    var t1, len, extrasLen, i, t2, c, padLength, currentCodeUnit, outputLen, out, o, x, j, i0, t3, o0;
    ...
    i = 0;
    for (; i < len; ++i) {
      t2 = t1.codeUnitAt$1(input, i);
      if (t2 >= 256)
        return H.ioore(C.List_q3m, t2);
      c = C.List_q3m[t2];
      if (c < 0) {
        ++extrasLen;
        if (c === -2)
          throw H.wrapException(P.FormatException$("Invalid character: " + H.S(t1.$index(input, i)), null, null));
      }
    }
    t2 = len - extrasLen;
    if (C.JSNumber_methods.$mod(t2, 4) !== 0)
      throw H.wrapException(P.FormatException$("Size of Base 64 characters in Input\r\n          must be a multiple of 4. Input: " + H.S(input), null, null));
...
["dart.async", "dart:async", , P, {
  ...
  }, "call$1", "_nullDataHandler$closure", 2, 0, 19, 12],
  ...
  }, null, "call$2", "call$1", "_nullErrorHandler$closure", 2, 2, 7, 13, 14, 15],
  ...
  _Future: {
    ...
    }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 7, 13, 14, 15],
    $isFuture: 1,
  ...
  _ForwardingStreamSubscription: {
    ...
    }, "call$2", "get$_handleError", 4, 0, 11, 14, 15],
...
["dart.collection", "dart:collection", , P, {
  ...
  }, "call$1", "_defaultHashCode$closure", 2, 0, 15, 21],
...
["dart.js", "dart:js", , P, {
  ...
  }, "call$1", "_convertToJS$closure", 2, 0, 2, 26],
...
["", "main.dart", , F, {
  ...
  main: [function() {
    var w, t1;
    w = new F.OdfWorker(null);
    t1 = new Worker("demo3.js");
    w.inner = t1;
    t1 = H.setRuntimeTypeInfo(new W._EventStream(t1, "message", false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.main_closure(w)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onClick$x(document.querySelector("#do-demo"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.main_closure0(w)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onClick$x(document.querySelector("#do-report"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.main_closure1(w)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
